...
if __name__ == '__main__':
    ...
    parser.add_argument('--checkpoint_path', type=str,
                        ...
                        default='D:/Side/SieProject/Wave2Lip/ckp/wav2lip_gan.pth', required=False)
    ...
    parser.add_argument('--face', type=str,
                        ...
                        default='D:/Side/SieProject/Wave2Lip/sample.jpg', required=False)
    ...
    if not os.path.isfile(args.face):
        ...
        video_strem = cv2.VideoCapture(args.face)
        fps = video_strem.get(cv2.CAP_PROP_FPS)

        print('Reading Video Frames...')

        full_frames = []
        while 1:
            still_reading, frame = video_strem.read()
    ...
    gen = inference.datagen(full_frames.copy(), mel_chunks)
